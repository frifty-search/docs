...
#### 4.3 [ Updating in usescase/index.tsx](broken-reference)

#### 4.4  [Updating the utils/appName.utils.tsx](broken-reference)

#### 4.5   [Updating in components/utils/renderApps.utils.tsx](broken-reference)
